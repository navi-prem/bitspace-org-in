...
import Pop from "./Pop";
import { Users } from "@/libs/utills/types";
...
const Memcomp = (data: Users) => {
    ...
    return (<div className="flex flex-col w-11/12 my-5">
        <div className="bg-[#dbd4f8] flex justify-start items-center rounded">
            <Image src={`https://github.com/${data.username}.png`}
                width={65} height={65} className="mx-4 my-4 ml-5 rounded-full basis-1" alt="userpfp" />
